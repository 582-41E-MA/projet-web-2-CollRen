...
const Confirmation = () => {
  ...
  return (
    <div className="container mx-auto p-6 min-h-screen mt-24">
      <h1 className="text-3xl font-extrabold text-center text-gray-800 mb-6">Confirmation de commande</h1>
      <div className="bg-white shadow-lg rounded-lg p-6 max-w-md mx-auto">
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Merci pour votre achat, {user.prenom}!</h2>
        <div className="border-t border-gray-200 pt-4">
          <h3 className="text-xl font-medium text-gray-600 mb-2">Résumé de la commande</h3>
          <div className="space-y-2">
            ...
            <p className="text-gray-800"><strong>Prix total (avec taxes):</strong> ${totalWithTax.toFixed(2)}</p>
          </div>
        </div>

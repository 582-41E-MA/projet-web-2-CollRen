...
const ConfirmationReservation = () => {
  ...
  return (
    <div className="container mx-auto p-6 min-h-screen mt-24">
      <h1 className="text-3xl font-extrabold text-center text-gray-800 mb-6">{t('confirmation.reservation')}</h1>
      <div className="bg-white shadow-lg rounded-lg p-6 max-w-md mx-auto">
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">{t('confirmation.thank_you')} , {user.prenom}!</h2>
        <div className="border-t border-gray-200 pt-4">
          <h3 className="text-xl font-medium text-gray-600 mb-2">{t('confirmation.reservation_summary')}</h3>
